...
Canonical schema migration completed in source on 2026-08-16 18:07 IST:
...
- `catalogue-query.js` now queries class arrays without legacy level compatibility.
- `catalogue-validator.js` validates the canonical array model and rejects a legacy `levels` field.
- Kit Builder and Book Details were updated to work with class arrays.
...
Next: begin Higher Education taxonomy/data design from actual CPC titles, then implement Higher Education before Competitive Exams and universal Browse/Search.
